                ...
                <a href="/genres/{{$genre->hashid()}}">
                    <div>
                        <div class="uk-inline uk-transition-toggle uk-overflow-hidden">
                            <img src="https://loremflickr.com/320/240/{{$genre->name}}" width="1800" height="1200"
                                 alt="">
                            <div class="uk-overlay uk-overlay-primary uk-position-top uk-padding-remove-vertical">
                                ...
                                <div
                                    class="uk-card-badge uk-label uk-transition-slides-top">{{$count}} {{\Illuminate\Support\Str::plural("movie", $count)}}</div>
                            </div>
                        </div>
                    </div>
                </a>
