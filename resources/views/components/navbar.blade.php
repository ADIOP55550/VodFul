                            ...
                            <div class="uk-navbar-dropdown-grid uk-child-width-1-2" uk-grid>
                                ...
                                <div>
                                    <ul class="uk-nav uk-navbar-dropdown-nav">
                                        ...
                                        <li>
                                            <a
                                                href="{{route('genres.show', ['genre'=>strtolower($genre->name)])}}">{{$genre->name}}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </div>
...
<div
    ...
    <nav class="uk-navbar-container  uk-hidden@s uk-position-z-index uk-light" uk-navbar="mode: click"
